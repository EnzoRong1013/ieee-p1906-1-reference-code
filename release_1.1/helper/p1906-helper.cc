...
#include "../model/p1906-net-device.h"
#include "../model/p1906-perturbation.h"
#include "../model/p1906-force.h"
#include "../model/p1906-field.h"
#include "../model/p1906-specificity.h"
#include "../model/p1906-medium.h"
#include "../model/p1906-communication-interface.h"
#include "../model/p1906-transmitter-communication-interface.h"
#include "../model/p1906-receiver-communication-interface.h"
...
P1906Helper::EnableLogComponents (void)
{
  ...
  LogComponentEnable ("P1906Force", LOG_LEVEL_ALL);
