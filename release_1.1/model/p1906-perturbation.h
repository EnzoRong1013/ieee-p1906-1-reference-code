...
#ifndef P1906_PERTURBATION
#define P1906_PERTURBATION
...
class P1906Perturbation : public Object
{
public:
  static TypeId GetTypeId (void);

  P1906Perturbation ();
  virtual ~P1906Perturbation ();

  Ptr<P1906MessageCarrier> CreateMessageCarrier (Ptr<Packet> p);
