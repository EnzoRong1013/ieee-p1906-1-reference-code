...
NS_LOG_COMPONENT_DEFINE ("P1906Force");

TypeId P1906Force::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906Force")
    .SetParent<Object> ();
  return tid;
}

P1906Force::P1906Force ()
{
...
double
P1906Force::ComputePropagationDelay (Ptr<P1906CommunicationInterface> src,
...
P1906Force::CalculateReceivedMessageCarrier(Ptr<P1906CommunicationInterface> src,
		                                    Ptr<P1906CommunicationInterface> dst,
		                                    Ptr<P1906MessageCarrier> message,
		                                    Ptr<P1906Field> field)
{
